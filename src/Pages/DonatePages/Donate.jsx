...
const stripePromise = loadStripe(
  "pk_test_51QuScuCmchDaGpKEvi9n6EhjNRpgjOKGrXuHBwXWsneQrKAf4YMQwqdu3ARr43JEtqByLx6c1hVEmXOmac4CfWGF00KMyCqf8T"
);
...
function DonatePage() {
  ...
  const handleDonate = async () => {
    try {
      ...
      const response = await fetch(
        "https://api.sahayogisaathi.org/payments/create.php",
        {
          method: "POST",
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 border border-gray-300 rounded shadow ">
      ...
      <label className="block mb-2 font-semibold">Donation Amount (USD)</label>
      <input
        type="number"
        min="1"
