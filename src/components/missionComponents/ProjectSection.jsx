    ...
    <section className="bg-white py-12 px-6 md:px-16 text-black">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Link to="/projects#p-past-0" className="relative rounded-xl overflow-hidden shadow-lg h-64 flex flex-col justify-center items-center text-center p-4 group cursor-pointer">
            <div
          ...
          <Link to="/projects#p-past-4" className="relative rounded-xl overflow-hidden shadow-lg h-64 flex flex-col justify-center items-center text-center p-4 group cursor-pointer">
            <div
              className="absolute inset-0 bg-cover bg-center transition-transform duration-500 group-hover:scale-105 group-hover:opacity-100"
              style={{
          ...
          <Link to="/projects#p-past-6" className="relative rounded-xl overflow-hidden shadow-lg h-64 flex flex-col justify-center items-center text-center p-4 group cursor-pointer">
            <div
              className="absolute inset-0 bg-cover bg-center transition-transform duration-500 group-hover:scale-105 group-hover:opacity-100"
              style={{
